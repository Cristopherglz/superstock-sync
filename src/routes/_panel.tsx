    ...
    <div className="min-h-screen bg-gradient-soft flex">
      ...
      <aside className="hidden lg:flex w-64 flex-col bg-sidebar text-sidebar-foreground">
        <div className="p-6 flex items-center gap-3">
          ...
          <div>
            <div className="font-display font-bold tracking-tight">Nimbus Stock</div>
        ...
        <div className="p-3 border-t border-sidebar-border">
          <div className="flex items-center gap-3 px-2 py-2">
            <div className="h-9 w-9 rounded-full bg-gradient-brand flex items-center justify-center text-white font-semibold text-sm">
            ...
            <button
              ...
              className="p-2 rounded-lg text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-foreground"
              title="Cerrar sesión"
            >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Topbar */}
        <header className="h-16 border-b bg-card/70 backdrop-blur-xl px-4 lg:px-8 flex items-center gap-4 sticky top-0 z-20">
          <div className="lg:hidden flex items-center gap-2">
            <div className="h-8 w-8 rounded-lg bg-gradient-brand flex items-center justify-center">
              <Boxes className="h-4 w-4 text-white" />
            </div>
            <span className="font-display font-bold">Nimbus</span>
          </div>
          <div className="flex-1 max-w-md relative">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
            <Input placeholder="Buscar productos, SKU, códigos..." className="pl-9 bg-secondary border-transparent" />
          </div>
          <Badge variant="outline" className="hidden sm:inline-flex gap-1.5 border-success/40 text-success bg-success/10">
